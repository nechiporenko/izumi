...
void 0!==b&&(b=Math.abs(b-d.dir)),Object.keys(R).forEach(function(c){var d=c.split(".")[0];a===d&&R[c].forEach(function(a){a(h(B()),b,r(Array.prototype.slice.call(Q)))})})}function r(a){return 1===a.length?a[0]:d.dir?a.reverse():a}function s(a,b,c,e){var f=function(b){return I.hasAttribute("disabled")?!1:l(I,T[14])?!1:(b=L(b),a===S.start&&void 0!==b.buttons&&b.buttons>1?!1:(b.calcPoint=b.points[d.ort],void c(b,e)))},g=[];return a.split(" ").forEach(function(a){b.addEventListener(a,f,!1),g.push([a,f])}),g}function t(a,b){var c,d,e=b.handles||H,f=!1,g=100*(a.calcPoint-b.start)/p(),h=e[0]===H[0]?0:1;if(c=K(g,b.positions,e.length>1),f=y(e[0],c[h],1===e.length),e.length>1){if(f=y(e[1],c[h?0:1],!1)||f)for(d=0;d<b.handles.length;d++)q("slide",d)}else f&&q("slide",h)}function u(a,b){var c=G.getElementsByClassName(T[15]),d=b.handles[0]===H[0]?0:1;c.length&&k(c[0],T[15]),a.cursor&&(document.body.style.cursor="",document.body.removeEventListener("selectstart",document.body.noUiListener));var e=document.documentElement;e.noUiListeners.forEach(function(a){e.removeEventListener(a[0],a[1])}),k(I,T[12]),q("set",d),q("change",d)}function v(a,b){var c=document.documentElement;if(1===b.handles.length&&(j(b.handles[0].children[0],T[15]),b.handles[0].hasAttribute("disabled")))return!1;a.stopPropagation();var d=s(S.move,c,t,{start:a.calcPoint,handles:b.handles,positions:[J[0],J[H.length-1]]}),e=s(S.end,c,u,{handles:b.handles});if(c.noUiListeners=d.concat(e),a.cursor){document.body.style.cursor=getComputedStyle(a.target).cursor,H.length>1&&j(I,T[12]);var f=function(){return!1};document.body.noUiListener=f,document.body.addEventListener("selectstart",f,!1)}}function w(a){var b,e,g=a.calcPoint,h=0;return a.stopPropagation(),H.forEach(function(a){h+=c(a)[d.style]}),b=h/2>g||1===H.length?0:1,g-=c(G)[d.style],e=100*g/p(),d.events.snap||f(I,T[14],300),H[b].hasAttribute("disabled")?!1:(y(H[b],e),q("slide",b),q("set",b),q("change",b),void(d.events.snap&&v(a,{handles:[H[h]]})))}function x(a){var b,c;if(!a.fixed)for(b=0;b<H.length;b+=1)s(S.start,H[b].children[0],v,{handles:[H[b]]});a.tap&&s(S.start,G,w,{handles:H}),a.drag&&(c=[G.getElementsByClassName(T[7])[0]],j(c[0],T[10]),a.fixed&&c.push(H[c[0]===H[0]?1:0].children[0]),c.forEach(function(a){s(S.start,a,v,{handles:H})}))}function y(a,b,c){var e=a!==H[0]?1:0,f=J[0]+d.margin,h=J[1]-d.margin,i=J[0]+d.limit,l=J[1]-d.limit;return H.length>1&&(b=e?Math.max(b,f):Math.min(b,h)),c!==!1&&d.limit&&H.length>1&&(b=e?Math.min(b,i):Math.max(b,l)),b=M.getStep(b),b=g(parseFloat(b.toFixed(7))),b===J[e]?!1:(a.style[d.style]=b+"%",a.previousSibling||(k(a,T[17]),b>50&&j(a,T[17])),J[e]=b,Q[e]=M.fromStepping(b),q("update",e),!0)}function z(a,b){var c,e,f;for(d.limit&&(a+=1),c=0;a>c;c+=1)e=c%2,f=b[e],null!==f&&f!==!1&&("number"==typeof f&&(f=String(f)),f=d.format.from(f),(f===!1||isNaN(f)||y(H[e],M.toStepping(f),c===3-d.dir)===!1)&&q("update",e))}function A(a){var b,c,e=h(a);for(d.dir&&d.handles>1&&e.reverse(),d.animate&&-1!==J[0]&&f(I,T[14],300),b=H.length>1?3:1,1===e.length&&(b=1),z(b,e),c=0;c<H.length;c++)q("set",c)}function B(){var a,b=[];for(a=0;a<d.handles;a+=1)b[a]=d.format.to(Q[a]);return r(b)}function C(){T.forEach(function(a){a&&k(I,a)}),I.innerHTML="",delete I.noUiSlider}function D(){var a=J.map(function(a,b){var c=M.getApplicableStep(a),d=i(String(c[2])),e=Q[b],f=100===a?null:c[2],g=Number((e-c[2]).toFixed(d)),h=0===a?null:g>=c[1]?c[2]:c[0]||!1;return[h,f]});return r(a)}function E(a,b){R[a]=R[a]||[],R[a].push(b),"update"===a.split(".")[0]&&H.forEach(function(a,b){q("update",b)})}function F(a){var b=a.split(".")[0],c=a.substring(b.length);Object.keys(R).forEach(function(a){var d=a.split(".")[0],e=a.substring(d.length);b&&b!==d||c&&c!==e||delete R[a]})}var G,H,I=b,J=[-1,-1],M=d.spectrum,Q=[],R={};if(I.noUiSlider)throw new Error("Slider was already initialized.");return G=P(d.dir,d.ort,I),H=O(d.handles,d.dir,G),N(d.connect,I,H),x(d.events),d.pips&&o(d.pips),{destroy:C,steps:D,on:E,off:F,get:B,set:A}}function R(a,b){if(!a.nodeName)throw new Error("noUiSlider.create requires a single element.");var c=J(b,a),d=Q(a,c);d.set(c.start),a.noUiSlider=d}var S=window.navigator.pointerEnabled?{start:"pointerdown",move:"pointermove",end:"pointerup"}:window.navigator.msPointerEnabled?{start:"MSPointerDown",move:"MSPointerMove",end:"MSPointerUp"}:{start:"mousedown touchstart",move:"mousemove touchmove",end:"mouseup touchend"},T=["noUi-target","noUi-base","noUi-origin","noUi-handle","noUi-horizontal","noUi-vertical","noUi-background","noUi-connect","noUi-ltr","noUi-rtl","noUi-dragable","","noUi-state-drag","","noUi-state-tap","noUi-active","","noUi-stacking"];w.prototype.getMargin=function(a){return 2===this.xPct.length?n(this.xVal,a):!1},w.prototype.toStepping=function(a){return a=r(this.xVal,this.xPct,a),this.direction&&(a=100-a),a},w.prototype.fromStepping=function(a){return this.direction&&(a=100-a),e(s(this.xVal,this.xPct,a))},w.prototype.getStep=function(a){return this.direction&&(a=100-a),a=t(this.xPct,this.xSteps,this.snap,a),this.direction&&(a=100-a),a},w.prototype.getApplicableStep=function(a){var b=q(a,this.xPct),c=100===a?2:1;return[this.xNumSteps[b-2],this.xVal[b-c],this.xNumSteps[b-c]]},w.prototype.convert=function(a){return this.getStep(this.toStepping(a))};var U={to:function(a){return a.toFixed(2)},from:Number};return{create:R}}),jQuery(document).ready(function(a){function b(){var b=a(".js-mainslider").children("ul");b.bxSlider({auto:!0,mode:"fade",pause:8e3,autoHover:!0})}function c(){function b(){c.reloadSlider(a.extend(d(),{startSlide:c.getCurrentSlide()}))}var c=a(".js-promo-slider"),d=function(){var b,c={maxSlides:1},d={maxSlides:2},e={maxSlides:3},f={minSlides:1,moveSlides:1,slideWidth:298,slideMargin:23,auto:!1,pager:!1,infiniteLoop:!1,hideControlOnEnd:!0},h=g.width();return 700>h&&(b=a.extend(c,f)),h>=700&&990>h&&(b=a.extend(d,f)),h>=990&&(b=a.extend(e,f)),b};c=c.bxSlider(d()),g.on("resize",function(){setTimeout(b,500)})}function d(){a(".js-quote-slider").bxSlider({auto:!1,pager:!1})}function e(){var b=a(".js-colorbox .colorbox");b.each(function(){var b=a(this),c=b.find("input");b.append('<i class="icon-ok colorbox__icon"></i>'),""!=b.data("color")&&b.css("background-color",a(this).data("color")),c.is(":checked")&&b.addClass("active")}),b.on("click",function(){var b=a(this),c=b.find("input");if("radio"==c.prop("type")){if(b.hasClass("active"))return!1;var d=b.parents("ul");d.find(".colorbox").removeClass("active"),b.addClass("active").find("input").prop("checked",!0)}else b.hasClass("active")?b.removeClass("active").find("input").prop("checked",!1):b.addClass("active").find("input").prop("checked",!0)})}function f(){var b=document.getElementById("priceslider"),c=Math.floor(a("#low_price").val()),d=Math.floor(a("#high_price").val());noUiSlider.create(b,{start:[c,d],step:100,connect:!0,range:{min:c,max:d}});var e=document.getElementById("low_price"),f=document.getElementById("high_price");b.noUiSlider.on("update",function(a,b){var c=a[b];b?f.value=Math.floor(c):e.value=Math.floor(c)}),a(".js-priceinput").keydown(function(b){-1!==a.inArray(b.keyCode,[46,8,9,27,13,110,190])||65==b.keyCode&&(b.ctrlKey===!0||b.metaKey===!0)||b.keyCode>=35&&b.keyCode<=40||(b.shiftKey||b.keyCode<48||b.keyCode>57)&&(b.keyCode<96||b.keyCode>105)&&b.preventDefault()}),e.addEventListener("change",function(){b.noUiSlider.set([this.value,null])}),f.addEventListener("change",function(){b.noUiSlider.set([null,this.value])})}var g=a(window),h=a("html"),i=a("body");i.append('<div id="overlay" class="overlay"></div>');var j=a("#overlay"),k=function(){function b(){h.hideSearch()}function c(){h.hideBlock()}var d=a(".js-search"),e=a(".js-search-toggle"),f=a(".js-userinfo"),g=a(".js-userinfo-toggle"),h={};return a(".b-header__controls").on("click",".js-search-toggle",function(){a(this).hasClass("active")?h.hideSearch():h.showSearch()}),a(".b-header__controls").on("click",".js-userinfo-toggle",function(){a(this).hasClass("active")?h.hideBlock():h.showBlock()}),h.showSearch=function(){c(),l.hideMenu(),d.addClass("active"),e.addClass("active"),j.show().bind("click",b)},h.hideSearch=function(){d.removeClass("active"),e.removeClass("active"),j.hide().unbind("click",b)},h.showBlock=function(){b(),l.hideMenu(),f.addClass("active"),g.addClass("active"),j.show().bind("click",c)},h.hideBlock=function(){f.removeClass("active"),g.removeClass("active"),j.hide().unbind("click",c)},h}(),l=function(){function b(){e.hideMenu()}var c=a(".js-mm"),d=a(".js-mm-toggle"),e={};return a(".b-header__controls").on("click",".js-mm-toggle",function(){a(this).hasClass("active")?e.hideMenu():e.showMenu()}),a(".js-mm").on("click",".m-menu__label",function(){e.hideMenu()}),e.showMenu=function(){k.hideSearch(),k.hideBlock(),d.addClass("active"),c.addClass("active"),j.show().bind("click",b),h.css("overflow","hidden")},e.hideMenu=function(){d.removeClass("active"),c.removeClass("active"),h.css("overflow","auto"),j.hide().unbind("click",b)},e}();(function(){var b=a(".js-notice");b.append('<a class="g-notice__close"><i class="icon-cancel"></i></a>'),b.on("click",".g-notice__close",function(b){b.preventDefault(),a(this).parent("div").fadeOut()})})(),function(){var b=a('<div class="scroll-up-btn"><i class="icon-up-open-big"></i></div>');i.append(b),g.on("scroll",function(){a(this).scrollTop()>300?b.show():b.hide()}),b.on("click",function(){return a("html, body").animate({scrollTop:0},800),!1})}();a(".js-mainslider").length&&b(),a(".js-promo-slider").length&&c(),a(".js-quote-slider").length&&d();var m=function(b){function c(){f.close()}var d,e,f={};return e=a('<a class="modal__close" href="#"><i class="icon-cancel"></i></a>'),e.on("click",function(a){a.preventDefault(),c()}),f.center=function(){var a,b;a=Math.max(g.height()-d.outerHeight(),0)/2,b=Math.max(g.width()-d.outerWidth(),0)/2,d.css({top:a+g.scrollTop(),left:b+g.scrollLeft()})},f.open=function(b){d=a(b),d.append(e),f.center(),g.bind("resize.modal",f.center),d.fadeIn(),j.addClass("full").show().bind("click",c)},f.close=function(){d.fadeOut("fast"),j.removeClass("full").hide().unbind("click",c),g.unbind("resize.modal")},f}();a("[data-modal]").on("click",function(b){b.preventDefault();var c=a(this).data("modal");c&&m.open(c)}),a(".js-colorbox").length&&e(),a(".js-priceslider").length&&!h.hasClass("lt-ie9")&&f();var n=function(){$loader=a('<span class="loader"></span>');var b={};return b.showIcon=function(){i.append($loader),j.addClass("full").show(),$loader.show()},b.hideIcon=function(){$loader.hide(),j.removeClass("full").hide(),$loader.remove()},b}();a("button[data-loader]").on("click",function(){n.showIcon(),setTimeout(n.hideIcon,600)}),Modernizr.svg||a('img[src*="svg"]').attr("src",function(){return a(this).attr("src").replace(".svg",".png")}),h.hasClass("lt-ie9")&&(a('input[type="checkbox"]').removeClass("css-checkbox"),a(".product-grid__item:nth-child(3n)").addClass("last"))});